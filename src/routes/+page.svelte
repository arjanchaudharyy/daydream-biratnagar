<script lang="ts">
	...
	const scheduleData: { title: string; items: { event: string; time: string; }[] }[] = [
		{
			...
			items: [
				{ event: "Doors open & check-in", time: "8:00 AM" },
				{ event: "Opening ceremony", time: "10:00 AM" },
				{ event: "Hacking begins (24 hours)", time: "10:30 AM" },
				{ event: "Lunch", time: "1:00 PM" },
				{ event: "Workshops & activities", time: "2:00 PM – 6:00 PM" },
				{ event: "Dinner", time: "7:00 PM" },
				{ event: "Midnight surprise", time: "12:00 AM" },
				{ event: "Breakfast", time: "8:00 AM (next day)" },
				{ event: "Submissions due & demos", time: "10:00 AM (next day)" },
				{ event: "Closing ceremony & prizes", time: "12:00 PM (next day)" }
			]
		}
	];
	...
	$: pageDescription = `Join Daydream ${eventName} in ${eventLocation}! A teen-led, 24-hour game jam where you'll build amazing games with other high schoolers. Food, workshops, and prizes included!`;
...
<style>
	...
	/* Animations (moved from bottom style block to keep a single style tag) */
	@keyframes fadeIn {
		from { opacity: 0; }
		to { opacity: 1; }
	}
	...
	.animate-scaleIn {
		animation: scaleIn 0.3s cubic-bezier(.4,2,.6,1);
	}
</style>
...
<div class="flex flex-col items-center justify-center h-screen text-center bg-gradient-to-b from-[#CCF4FD] to-[#B8D9F8] bg-blend-overlay relative">
	...
	<div class="buildings-front-parallax absolute top-0 left-0 w-full h-full bg-[url(/buildings-front.png)] bg-no-repeat bg-contain pointer-events-none lg:-translate-y-15 -z-10"></div>
	...
	<div class="hero-ui-parallax flex flex-col items-center justify-center text-center relative z-5 -translate-y-2">
		...
		<div class="relative inline-block px-4">
			...
			>
				Organized by <a href="https://arnikohackclub.com" target="_blank" rel="noopener" class="underline">Arniko Hackclub</a>
			</h4>
		</div>
		
		<a href={signupLink} target="_blank" rel="noopener noreferrer" class="mt-6 px-6 py-3 bg-pink border-b-2 border-b-pink-dark text-white rounded-full font-sans cursor-pointer transition-all duration-100 hover:shadow-[0_2px_0_0_theme(colors.pink.dark)] hover:-translate-y-[2px] active:translate-y-0.5 active:border-transparent active:shadow-none">Register now</a>
		
		<div class="mt-4 flex w-full justify-center">
			<div class="inline-flex items-center gap-2 bg-white/80 text-[#3F709A] border border-[#AECDF6] rounded-full px-5 py-2 font-sans text-sm shadow-md">
				<span>🏆</span>
				<span class="font-bold">4L+ Prize Pool • Max 3/team • No registration fees</span>
			</div>
		</div>
	</div>
	...
	<img src="/clouds-top-middle.png" alt="" class="absolute left-5/12 -translate-x-1/2 w-7/12 -bottom-24 z-0 pointer-events-none">
	<img src="/clouds-top-right.png" alt="" class="absolute right-0 w-1/2 -bottom-12 translate-y-1/2 z-0 pointer-events-none">
	<img src="/clouds-top-left.png" alt="" class="absolute left-0 w-3/12 -bottom-12  translate-y-1/2 z-0 pointer-events-none">
...
<!-- Event Highlights -->
<div class="w-full bg-[#FCEFC5] py-10 px-6 flex justify-center relative">
	<div class="max-w-4xl w-full bg-white/60 rounded-xl border border-[#EBD9B0] p-6 relative z-30">
		<h2 class="text-3xl font-serif text-[#8B4513] mb-4">Daydream Biratnagar</h2>
		<p class="font-sans text-[#60574b] mb-4">Build amazing projects, learn new skills, and connect with fellow hackers in our 24-hour hackathon. Teams can have up to 3 people.</p>
		<div class="grid grid-cols-1 md:grid-cols-2 gap-4 font-sans text-[#477783]">
			<div class="bg-white/60 rounded-lg p-4 border border-[#d1e3ee]">
				<p class="font-semibold">Arniko College Biratnagar</p>
				<p>28th September • 24 Hours</p>
				<p class="opacity-90">Intensive coding day to build your dream project</p>
			</div>
			<div class="bg-white/60 rounded-lg p-4 border border-[#d1e3ee]">
				<p class="font-semibold">Team Up</p>
				<p>Work solo or form teams with other passionate hackers</p>
			</div>
			<div class="bg-white/60 rounded-lg p-4 border border-[#d1e3ee]">
				<p class="font-semibold">3–5 Lakh NRS+</p>
				<p>Prizes worth 300,000 to 500,000 NRS+ and recognition</p>
			</div>
			<div class="bg-white/60 rounded-lg p-4 border border-[#d1e3ee]">
				<p class="font-semibold">Contact & Register</p>
				<p><a href={signupLink} target="_blank" rel="noopener noreferrer" class="underline">Register now</a></p>
				<p class="mt-1">Updates: <a href="tel:+97798177652005" class="underline">+977 98177652005</a></p>
				<p class="mt-1">Instagram: <a href="https://instagram.com/arnikohackclub" target="_blank" rel="noopener noreferrer" class="underline">@arnikohackclub</a></p>
				<p class="mt-1">Main page: <a href="https://arnikohackclub.com" target="_blank" rel="noopener noreferrer" class="underline">arnikohackclub</a></p>
			</div>
		</div>
		<div class="mt-6 bg-white/60 rounded-lg p-4 border border-[#d1e3ee]">
			<p class="font-serif text-[#8B4513] text-lg mb-2">🎁 What's Included</p>
			<p class="font-sans text-[#477783]">Free Tshirt, Swags & Food for all participants throughout the event</p>
		</div>
	</div>
	<!-- Ensure any stray clouds stay behind -->
	...
	<div class="grid grid-cols-2 gap-8 max-w-6xl px-8 z-10 max-[900px]:grid-cols-1 max-md:gap-16">
		...
		<div class="relative transform rotate-1">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				...
				<p class="text-sm">Definitely! Contact us via biratnagar@daydream.hackclub.com or join #daydream on slack.</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-2">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				...
				<p class="text-sm">We're here to help! You can see our parent guide here, or they can reach out to us at biratnagar@daydream.hackclub.com for questions.</p>
			</div>
		</div>
...
{/if}
<!-- Enhanced Video Popup Modal with Animation and Improved Mail Form Handling -->

<!-- Video Popup Modal with fade-in animation and backdrop blur -->
{#if showVideoPopup}
	<!-- svelte-ignore a11y_click_events_have_key_events -->
	<div
		class="fixed inset-0 bg-[rgba(0,0,0,0.5)] bg-opacity-70 flex items-center justify-center z-12000 backdrop-blur-sm animate-fadeIn"
		on:click={closeVideoPopup}
		on:keydown={(e) => e.key === 'Escape' && closeVideoPopup()}
		role="dialog"
		aria-modal="true"
	...
	>
		<button
			class="cursor-pointer absolute top-4 right-4 z-10 w-8 h-8 bg-[rgba(255,255,255,0.2)] hover:bg-opacity-30 rounded-full flex items-center justify-center text-white text-xl font-bold transition-colors duration-200 shadow-lg"
			on:click={closeVideoPopup}
			aria-label="Close video"
		>
			<span class="-translate-y-0.5">×</span>
		...
		<!-- svelte-ignore a11y_no_static_element_interactions -->
		<div
			class="relative w-[90vw] h-[90vh] max-w-6xl max-h-[80vh] bg-black rounded-lg overflow-hidden shadow-2xl border-2 border-white/10 animate-scaleIn"
			on:click|stopPropagation
		>
			<iframe
				src="https://www.youtube.com/embed/hNYsNSY7Vz0?autoplay=1"
