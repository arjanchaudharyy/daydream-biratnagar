...
<div class="flex flex-col items-center justify-center h-screen text-center bg-gradient-to-b from-[#CCF4FD] to-[#B8D9F8] bg-blend-overlay relative">
	...
	<div class="hero-ui-parallax flex flex-col items-center justify-center text-center relative z-30 -translate-y-2">
		<div class="inline-block relative">
			...
			>
				24-hour hackathon on September 28th, 2025
			</h2>
	...
	<!-- Event Highlights -->
	<div class="relative z-40 w-full max-w-3xl mx-auto mt-4 px-4">
		<div class="bg-white/70 rounded-lg border border-white/60 shadow-sm p-5 text-left">
			<h3 class="text-2xl font-serif text-[#3F709A] mb-2">Event Highlights</h3>
			<ul class="list-disc pl-6 text-[#335969] font-sans space-y-1">
				<li>24-hour hackathon on September 28th • max 3 people per team</li>
				<li>Updates: <a href="tel:+97798177652005" class="underline">+977 98177652005</a></li>
				<li>Instagram: <a href="https://instagram.com/arnikohackclub" target="_blank" rel="noopener" class="underline">@arnikohackclub</a></li>
				<li>Main page: <a href="https://arnikohackclub.com" target="_blank" rel="noopener" class="underline">arnikohackclub</a></li>
			</ul>
		</div>
	</div>
