<div class="w-full bg-[#FFFFF8] relative min-h-80">
	...
	>
		...
		<div class="flex space-x-4 max-md:flex-col max-md:space-x-0 max-md:space-y-2">
			...
			<span class="text-gray-700 max-md:hidden">・</span>
			<a
				href="https://instagram.com/arnikohackclub"
				target="_blank" rel="noopener"
				class="underline text-gray-700 hover:text-gray-900 transition-colors">@arnikohackclub</a
			>
			<span class="text-gray-700 max-md:hidden">・</span>
			<a
				href="https://arnikohackclub.com"
				target="_blank" rel="noopener"
				class="underline text-gray-700 hover:text-gray-900 transition-colors">arnikohackclub.com</a
			>
		</div>
	</div>
